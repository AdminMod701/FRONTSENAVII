...
function peticionProd () {
    ...
    $.ajax({
        url:"http://140.238.191.252:8080/api/laptop/all",
        type:"GET",
...
function datosProductos(items) {
    ...
    var table = '<h2>Listado de Productos</h2><a href="productoForm.html" class="btn btn-secondary" id="new-product">Nueva consulta</a><table class="table"><tr><th>Marca</th><th>Modelo</th><th>Descripción</th><th colspan="2">Acciones</th></tr>';
...
function creaForm (item){
    ...
    var form =  `<form id="" class="p-4">
                    <h2 class="text-center text-dark">Registrar Consulta</h2>
