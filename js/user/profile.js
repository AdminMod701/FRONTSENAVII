...
function getSelectedProduct(){
    ...
    if(can){
        $.ajax({
            url: 'http://140.238.191.252:8080/api/laptop/'+value,
            type: 'GET',
            contentType: 'application/json',
            success: function(response){
...
function postOrder(){
    ...
    for(let i=1; i<cantidadProductos.length;i++ ){
        iProv = i.toString();
        $.ajax({
            url: 'http://140.238.191.252:8080/api/laptop/'+cantidadProductos[i],
            type: 'GET',
            contentType: 'application/json',
            success: function(response){
...
function getIdOrder(){
    $.ajax({
        url: "http://140.238.191.252:8080/api/order/all",
        type: "GET",
        contentType: "application/json",
        success: function(response){
            for(let i=0; i < response.length; i++){
...
function allOrder(){
    ...
    $.ajax({
        url: 'http://140.238.191.252:8080/api/order/new',
        type: 'POST',
        contentType: 'application/json',
        dataType: 'json',
